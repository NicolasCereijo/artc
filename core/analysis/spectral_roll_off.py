...
def calculate_spectral_roll_off(audio_signal: np.ndarray, sample_rate: float, /,
    ...
    spectral_centroids = spectral_centroid.calculate_spectral_centroid(audio_signal, sample_rate, n_fft=n_fft)
...
def compare_two_spectral_roll_off(audio_signal1: np.ndarray, audio_signal2: np.ndarray,
                                  ...
                                  *, n_fft: int = 512, roll_percent: float = 0.5) -> float:
    roll_off1 = calculate_spectral_roll_off(audio_signal1, sample_rate1, n_fft=n_fft, roll_percent=roll_percent)
    roll_off2 = calculate_spectral_roll_off(audio_signal2, sample_rate2, n_fft=n_fft, roll_percent=roll_percent)
