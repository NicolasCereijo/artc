...
def compare_two_temporal_flux(audio_signal1: np.ndarray, audio_signal2: np.ndarray,
    ...
    flux1 = calculate_temporal_flux(audio_signal1, sample_rate1, hop_length=hop_length)
    flux2 = calculate_temporal_flux(audio_signal2, sample_rate2, hop_length=hop_length)
