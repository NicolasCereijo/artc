...
def compare_two_spect_bandwidth(audio_signal1: np.ndarray, audio_signal2: np.ndarray,
    ...
    bandwidth1 = calculate_spectral_bandwidth(audio_signal1, sample_rate1, n_fft=n_fft)
    bandwidth2 = calculate_spectral_bandwidth(audio_signal2, sample_rate2, n_fft=n_fft)
