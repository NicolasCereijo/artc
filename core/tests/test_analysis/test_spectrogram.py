...
def test_compare_two_spectrogram(setup):
    ...
    assert analysis.compare_two_spectrogram(audio_signal1, audio_signal1,
                                            n_fft=n_fft) == 1
    assert analysis.compare_two_spectrogram(audio_signal2, audio_signal2,
                                            n_fft=n_fft) == 1
...
def test_compare_multiple_spectrogram(setup):
    ...
    assert analysis.compare_multiple_spectrogram([audio_signal1, audio_signal1],
                                                 n_fft=n_fft) == 1
    assert analysis.compare_multiple_spectrogram([audio_signal2, audio_signal2],
                                                 n_fft=n_fft) == 1
    ...
    assert analysis.compare_multiple_spectrogram(
