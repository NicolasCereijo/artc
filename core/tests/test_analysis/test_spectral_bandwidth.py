...
def test_compare_two_spect_bandwidth(setup):
    ...
    assert analysis.compare_two_spect_bandwidth(audio_signal3, audio_signal3,
                                                ...
                                                n_fft=n_fft) == 1
    assert round(analysis.compare_two_spect_bandwidth(audio_signal1, audio_signal2,
                                                      sample_rate1, sample_rate2,
                                                      n_fft=n_fft), 5) == 0.84616
    assert round(analysis.compare_two_spect_bandwidth(audio_signal2, audio_signal1,
                                                      sample_rate2, sample_rate1,
                                                      n_fft=n_fft), 5) == 0.84616
    assert round(analysis.compare_two_spect_bandwidth(audio_signal1, audio_signal3,
                                                      sample_rate1, sample_rate3,
                                                      n_fft=n_fft), 5) == 0.83814
    assert round(analysis.compare_two_spect_bandwidth(audio_signal3, audio_signal1,
                                                      sample_rate3, sample_rate1,
                                                      n_fft=n_fft), 5) == 0.83814
    assert round(analysis.compare_two_spect_bandwidth(audio_signal2, audio_signal3,
                                                      sample_rate2, sample_rate3,
                                                      n_fft=n_fft), 5) == 0.84931
    assert round(analysis.compare_two_spect_bandwidth(audio_signal3, audio_signal2,
...
def test_compare_multiple_spect_bandwidth(setup):
    ...
    assert analysis.compare_multiple_spect_bandwidth([audio_signal3, audio_signal3],
                                                     [sample_rate3, sample_rate3],
                                                     n_fft=n_fft) == 1
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal1, audio_signal2],
                                                           [sample_rate1, sample_rate2],
                                                           n_fft=n_fft), 5) == 0.84616
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal2, audio_signal1],
                                                           [sample_rate2, sample_rate1],
                                                           n_fft=n_fft), 5) == 0.84616
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal1, audio_signal3],
                                                           [sample_rate1, sample_rate3],
                                                           n_fft=n_fft), 5) == 0.83814
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal3, audio_signal1],
                                                           [sample_rate3, sample_rate1],
                                                           n_fft=n_fft), 5) == 0.83814
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal2, audio_signal3],
                                                           [sample_rate2, sample_rate3],
                                                           n_fft=n_fft), 5) == 0.84931
    assert round(analysis.compare_multiple_spect_bandwidth([audio_signal3, audio_signal2],
                                                           [sample_rate3, sample_rate2],
                                                           n_fft=n_fft), 5) == 0.84931
